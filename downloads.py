...
def download_single_video(url: str, output_path: str, thread_id: int = 0, audio_only: bool = False, used_personnalized_output_path=0) -> dict:
    """
    ...
    if is_playlist:
        ...
        if used_personnalized_output_path:
...
def download_youtube_content(urls: List[str], output_path: Optional[str] = None,
    ...
    if output_path is None:
        output_path = "/Users/charles/Downloads/"
